...
The simulation uses sdl3 for the graphical part of the program.

Has been only tested on arch linux, other operating systems might require additional setup.
